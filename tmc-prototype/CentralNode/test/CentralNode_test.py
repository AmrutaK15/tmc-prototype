...
class CentralNodeDeviceTestCase(DeviceTestCase):
    ...
    device = CentralNode
    properties = {'SkaLevel': '4', 'MetricList': 'healthState', 'GroupDefinitions': '', 'CentralLoggingTarget': '', 'ElementLoggingTarget': '', 'StorageLoggingTarget': 'localhost', 'CentralAlarmHandler': '', 'TMAlarmHandler': '', 'TMMidSubarrayNodes': '', 'NumDishes': '', 'DishLeafNodePrefix': 'ska_mid/tm_leaf_node/d', 
                  }
